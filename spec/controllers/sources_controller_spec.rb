  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved source as @source" do
        ...
        post :create, {:source => { "name" => "invalid value" }}, valid_session
        assigns(:source).should be_a_new(Source)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested source" do
        ...
        Source.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => source.to_param, :source => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the source as @source" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Source.any_instance.stub(:save).and_return(false)
        put :update, {:id => source.to_param, :source => { "name" => "invalid value" }}, valid_session
        assigns(:source).should eq(source)
      end
