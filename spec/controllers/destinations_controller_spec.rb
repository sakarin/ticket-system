  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved destination as @destination" do
        ...
        post :create, {:destination => { "name" => "invalid value" }}, valid_session
        assigns(:destination).should be_a_new(Destination)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested destination" do
        ...
        Destination.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => destination.to_param, :destination => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the destination as @destination" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Destination.any_instance.stub(:save).and_return(false)
        put :update, {:id => destination.to_param, :destination => { "name" => "invalid value" }}, valid_session
        assigns(:destination).should eq(destination)
      end
